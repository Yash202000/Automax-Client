...
window.APP_CONFIG = {
  ...
  SESSION_TIMEOUT_MINUTES: "${VITE_SESSION_TIMEOUT_MINUTES:-15}",
  APP_VERSION: "${VITE_APP_VERSION:-v1.0.2}",
  ENABLE_SIGNUP: "${VITE_ENABLE_SIGNUP:-true}",
};
EOF
...
echo "  SESSION_TIMEOUT_MINUTES: ${VITE_SESSION_TIMEOUT_MINUTES:-15}"
echo "  APP_VERSION: ${VITE_APP_VERSION:-v1.0.2}"
echo "  ENABLE_SIGNUP: ${VITE_ENABLE_SIGNUP:-true}"
