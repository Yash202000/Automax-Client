        ...
        <header className="h-[70px] bg-white dark:bg-sidebar border-b border-slate-200/80 dark:border-white/5 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-30 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 text-sm">
              ...
              <span className="font-semibold text-slate-700 dark:text-muted-foreground">
                {getPageTitle()}
              </span>
            </div>
            ...
            */}
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 p-1.5 pr-3 hover:bg-slate-50 cursor-pointer rounded-xl transition-colors group"
              >
                {user?.avatar ? (
                  <img
                    src={user.avatar}
