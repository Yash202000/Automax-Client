...
export const userApi = {
  list: async (
    ...
    if (departmentIds.length)
      params.append("department_ids", departmentIds.join(","));
  ...
  create: async (
    ...
    if (avatarFile) {
      ...
      if (data.department_ids?.length)
        formData.append("department_ids", JSON.stringify(data.department_ids));
      if (data.location_ids?.length)
        formData.append("location_ids", JSON.stringify(data.location_ids));
      if (data.classification_ids?.length)
        formData.append(
          "classification_ids",
          JSON.stringify(data.classification_ids),
        );
  ...
  match: async (
    data: UserMatchRequest,
  ): Promise<ApiResponse<UserMatchResponse>> => {
    const response = await apiClient.post<ApiResponse<UserMatchResponse>>(
      "/admin/users/match",
      data,
    );
    return response.data;
...
export const classificationApi = {
  create: async (
    ...
    const response = await apiClient.post<ApiResponse<Classification>>(
  ...
  update: async (
    ...
    const response = await apiClient.put<ApiResponse<Classification>>(
      `/admin/classifications/${id}`,
      data,
    );
    return response.data;
  ...
  > => {
    ...
    const response = await apiClient.post<
      ApiResponse<{ imported: number; skipped: number; errors: string[] }>
    >("/admin/classifications/import", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    });
    return response.data;
  },
  ...
  getCriticalities: async (
    classificationId: string,
  ): Promise<ApiResponse<ClassificationCriticality[]>> => {
    const response = await apiClient.get<
      ApiResponse<ClassificationCriticality[]>
    >(`/admin/classifications/${classificationId}/criticalities`);
    return response.data;
  },

  createCriticality: async (
    classificationId: string,
    data: ClassificationCriticalityCreateRequest,
  ): Promise<ApiResponse<ClassificationCriticality>> => {
    const response = await apiClient.post<
      ApiResponse<ClassificationCriticality>
    >(`/admin/classifications/${classificationId}/criticalities`, data);
    return response.data;
  },

  getCriticalityById: async (
    id: string,
  ): Promise<ApiResponse<ClassificationCriticality>> => {
    const response = await apiClient.get<
      ApiResponse<ClassificationCriticality>
  ...
  updateCriticality: async (
    ...
    const response = await apiClient.put<
      ApiResponse<ClassificationCriticality>
    >(`/admin/classifications/criticalities/${id}`, data);
    return response.data;
  },
...
export const locationApi = {
  ...
  getByType: async (type: string): Promise<ApiResponse<Location[]>> => {
    const response = await apiClient.get<ApiResponse<Location[]>>(
      `/admin/locations/by-type?type=${type}`,
    );
    return response.data;
  },
  ...
  > => {
    ...
    const response = await apiClient.post<
      ApiResponse<{ imported: number; skipped: number; errors: string[] }>
    >("/admin/locations/import", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    });
    return response.data;
  },
...
export const departmentApi = {
  ...
  match: async (
    data: DepartmentMatchRequest,
  ): Promise<ApiResponse<DepartmentMatchResponse>> => {
    const response = await apiClient.post<ApiResponse<DepartmentMatchResponse>>(
      "/admin/departments/match",
      data,
    );
    return response.data;
  },
  ...
  > => {
    ...
    const response = await apiClient.post<
      ApiResponse<{ imported: number; skipped: number; errors: string[] }>
    >("/admin/departments/import", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    });
    return response.data;
  },
...
export const actionLogApi = {
  ...
  getById: async (id: string): Promise<ApiResponse<ActionLog>> => {
    const response = await apiClient.get<ApiResponse<ActionLog>>(
  ...
  getStats: async (): Promise<ApiResponse<ActionLogStats>> => {
    const response = await apiClient.get<ApiResponse<ActionLogStats>>(
      "/admin/action-logs/stats",
    );
    return response.data;
  },

  getFilterOptions: async (): Promise<ApiResponse<ActionLogFilterOptions>> => {
    const response = await apiClient.get<ApiResponse<ActionLogFilterOptions>>(
      "/admin/action-logs/filter-options",
    );
    return response.data;
  },
  ...
  cleanup: async (
    ...
    ApiResponse<{ deleted_count: number; retention_days: number }>
  > => {
  ...
  export: async (
    ...
    const response = await apiClient.get(
      `/admin/action-logs/export?${params.toString()}`,
      {
        responseType: "blob",
      },
    );
...
export const workflowApi = {
  ...
  createState: async (
    workflowId: string,
    data: WorkflowStateCreateRequest,
  ): Promise<ApiResponse<WorkflowState>> => {
    const response = await apiClient.post<ApiResponse<WorkflowState>>(
      `/admin/workflows/${workflowId}/states`,
      data,
    );
    return response.data;
  },
  ...
  listStates: async (
    ...
    const response = await apiClient.get<ApiResponse<WorkflowState[]>>(
      `/admin/workflows/${workflowId}/states`,
    );
    return response.data;
  },
  ...
  updateState: async (
    ...
    const response = await apiClient.put<ApiResponse<WorkflowState>>(
      `/admin/workflows/${workflowId}/states/${stateId}`,
      data,
    );
    return response.data;
  },
  ...
  createTransition: async (
    workflowId: string,
    data: WorkflowTransitionCreateRequest,
  ): Promise<ApiResponse<WorkflowTransition>> => {
    const response = await apiClient.post<ApiResponse<WorkflowTransition>>(
  ...
  updateTransition: async (
    ...
    const response = await apiClient.put<ApiResponse<WorkflowTransition>>(
  ...
  setTransitionRoles: async (
    transitionId: string,
    roleIds: string[],
  ): Promise<ApiResponse<WorkflowTransition>> => {
    const response = await apiClient.put<ApiResponse<WorkflowTransition>>(
      `/admin/transitions/${transitionId}/roles`,
      { role_ids: roleIds },
    );
    return response.data;
  },

  setTransitionRequirements: async (
    transitionId: string,
    requirements: TransitionRequirementRequest[],
  ): Promise<ApiResponse<WorkflowTransition>> => {
    const response = await apiClient.put<ApiResponse<WorkflowTransition>>(
      `/admin/transitions/${transitionId}/requirements`,
      { requirements },
    );
    return response.data;
  },

  setTransitionActions: async (
    transitionId: string,
    actions: TransitionActionRequest[],
  ): Promise<ApiResponse<WorkflowTransition>> => {
    const response = await apiClient.put<ApiResponse<WorkflowTransition>>(
      `/admin/transitions/${transitionId}/actions`,
      { actions },
    );
    return response.data;
  },

  setTransitionFieldChanges: async (
    transitionId: string,
    fieldChanges: TransitionFieldChangeRequest[],
  ): Promise<ApiResponse<WorkflowTransition>> => {
    const response = await apiClient.put<ApiResponse<WorkflowTransition>>(
      `/admin/transitions/${transitionId}/field-changes`,
  ...
  assignClassifications: async (
    workflowId: string,
    classificationIds: string[],
  ): Promise<ApiResponse<Workflow>> => {
    const response = await apiClient.put<ApiResponse<Workflow>>(
      `/admin/workflows/${workflowId}/classifications`,
      { classification_ids: classificationIds },
    );
    return response.data;
  },

  getByClassification: async (
    classificationId: string,
  ): Promise<ApiResponse<Workflow>> => {
    const response = await apiClient.get<ApiResponse<Workflow>>(
      `/admin/workflows/by-classification/${classificationId}`,
    );
    return response.data;
  },
  ...
  updateMatchConfig: async (
    ...
    const response = await apiClient.put<ApiResponse<Workflow>>(
      `/admin/workflows/${workflowId}/match-config`,
      config,
    );
    return response.data;
  },
...
export const incidentApi = {
  ...
  listRequests: async (
    filter: Omit<IncidentFilter, "record_type"> = {},
  ): Promise<PaginatedResponse<Incident>> => {
  ...
  convertToRequest: async (
    id: string,
    data: ConvertToRequestRequest,
  ): Promise<ApiResponse<ConvertToRequestResponse>> => {
    const response = await apiClient.post<
  ...
  bulkConvertToRequest: async (
    data: BulkConvertToRequestRequest,
  ): Promise<ApiResponse<any>> => {
    const response = await apiClient.post<ApiResponse<any>>(
      `incidents/bulk/convert-to-request`,
      data,
    );
    return response.data;
  },
  ...
  canConvertToRequest: async (
    id: string,
  ): Promise<ApiResponse<CanConvertToRequestResponse>> => {
    const response = await apiClient.get<
      ApiResponse<CanConvertToRequestResponse>
    >(`/incidents/${id}/can-convert`);
    return response.data;
  },
  ...
  getAvailableTransitions: async (
    ...
    const response = await apiClient.get<ApiResponse<AvailableTransition[]>>(
  ...
  getHistory: async (id: string): Promise<ApiResponse<TransitionHistory[]>> => {
    const response = await apiClient.get<ApiResponse<TransitionHistory[]>>(
  ...
  addComment: async (
    ...
    const response = await apiClient.post<ApiResponse<IncidentComment>>(
  ...
  updateComment: async (
    ...
    const response = await apiClient.put<ApiResponse<IncidentComment>>(
  ...
  uploadAttachment: async (
    incidentId: string,
    file: File,
  ): Promise<ApiResponse<IncidentAttachment>> => {
    const formData = new FormData();
    formData.append("file", file);
    const response = await apiClient.post<ApiResponse<IncidentAttachment>>(
  ...
  listAttachments: async (
    ...
    const response = await apiClient.get<ApiResponse<IncidentAttachment[]>>(
      `/incidents/${incidentId}/attachments`,
    );
    return response.data;
  },
  ...
  getMyAssigned: async (
    ...
    if (recordType) params.append("record_type", recordType);
    const response = await apiClient.get<PaginatedResponse<Incident>>(
      `/incidents/my-assigned?${params.toString()}`,
    );
    return response.data;
  },
  ...
  getMyReported: async (
    ...
    if (recordType) params.append("record_type", recordType);
    const response = await apiClient.get<PaginatedResponse<Incident>>(
      `/incidents/my-reported?${params.toString()}`,
    );
    return response.data;
  },
  ...
  getRevisions: async (
    ...
    if (filter.performed_by_id)
      params.append("performed_by_id", filter.performed_by_id);
    if (filter.start_date) params.append("start_date", filter.start_date);
    if (filter.end_date) params.append("end_date", filter.end_date);
  ...
  exportRevisions: async (
    incidentId: string,
    format: "xlsx" | "pdf",
  ): Promise<Blob> => {
    const response = await apiClient.get(
      `/incidents/${incidentId}/revisions/export?format=${format}`,
      {
        responseType: "blob",
      },
    );
...
export const complaintApi = {
  ...
  getAvailableTransitions: async (
    ...
    const response = await apiClient.get<ApiResponse<AvailableTransition[]>>(
      `/complaints/${id}/available-transitions`,
    );
    return response.data;
  },
  ...
  incrementEvaluation: async (
    id: string,
  ): Promise<ApiResponse<IncidentDetail>> => {
    const response = await apiClient.post<ApiResponse<IncidentDetail>>(
      `/complaints/${id}/evaluate`,
    );
    return response.data;
  },
...
export const queryApi = {
  ...
  getAvailableTransitions: async (
    ...
    const response = await apiClient.get<ApiResponse<AvailableTransition[]>>(
      `/queries/${id}/available-transitions`,
    );
    return response.data;
  },
  ...
  deleteAttachment: async (
    ...
    const response = await apiClient.delete<ApiResponse<null>>(
      `/queries/${queryId}/attachments/${attachmentId}`,
    );
    return response.data;
  },
...
export const requestApi = {
  ...
  updateComment: async (
    ...
    const response = await apiClient.put<ApiResponse<IncidentComment>>(
      `/incidents/${requestId}/comments/${commentId}`,
      data,
    );
    return response.data;
  },
  ...
  uploadAttachment: async (
    ...
    formData.append("file", file);
    const response = await apiClient.post<ApiResponse<IncidentAttachment>>(
      `/incidents/${requestId}/attachments`,
      formData,
      {
        headers: { "Content-Type": "multipart/form-data" },
      },
  ...
  deleteAttachment: async (
    ...
    const response = await apiClient.delete<ApiResponse<null>>(
      `/incidents/${requestId}/attachments/${attachmentId}`,
    );
    return response.data;
  },
...
export const reportApi = {
  ...
  ): Promise<ApiResponse<ReportFieldDefinition[]>> => {
  ...
  ): Promise<ReportQueryResponse<T>> => {
    const response = await apiClient.post<ReportQueryResponse<T>>(
      "/admin/reports/query",
      request,
    );
    return response.data;
  ...
  shareTemplate: async (
    id: string,
    data: ReportTemplateShareRequest,
  ): Promise<ApiResponse<ReportTemplate>> => {
    const response = await apiClient.post<ApiResponse<ReportTemplate>>(
...
export const lookupApi = {
  ...
  listCategories: async (): Promise<ApiResponse<LookupCategory[]>> => {
    const response = await apiClient.get<ApiResponse<LookupCategory[]>>(
  ...
  getCategory: async (id: string): Promise<ApiResponse<LookupCategory>> => {
    const response = await apiClient.get<ApiResponse<LookupCategory>>(
      `/admin/lookups/categories/${id}`,
    );
    return response.data;
  },

  createCategory: async (
    data: LookupCategoryCreateRequest,
  ): Promise<ApiResponse<LookupCategory>> => {
    const response = await apiClient.post<ApiResponse<LookupCategory>>(
      "/admin/lookups/categories",
      data,
    );
    return response.data;
  ...
  updateCategory: async (
    ...
    const response = await apiClient.put<ApiResponse<LookupCategory>>(
      `/admin/lookups/categories/${id}`,
      data,
    );
    return response.data;
  ...
  listValues: async (
    categoryId: string,
  ): Promise<ApiResponse<LookupValue[]>> => {
    const response = await apiClient.get<ApiResponse<LookupValue[]>>(
      `/admin/lookups/categories/${categoryId}/values`,
    );
    return response.data;
  },
  ...
  createValue: async (
    ...
    const response = await apiClient.post<ApiResponse<LookupValue>>(
      `/admin/lookups/categories/${categoryId}/values`,
      data,
    );
    return response.data;
  ...
  updateValue: async (
    ...
    const response = await apiClient.put<ApiResponse<LookupValue>>(
      `/admin/lookups/values/${id}`,
      data,
    );
    return response.data;
...
export const smsApi = {
  list: async (filter: SMSFilter = {}): Promise<PaginatedResponse<SMS>> => {
    ...
    const response = await apiClient.get<PaginatedResponse<SMS>>(
      `/notifications?${params.toString()}`,
    );
    return response.data;
  },
...
export const incidentMergeApi = {
  canMerge: async (
    workflowId?: string,
  ): Promise<ApiResponse<CanMergeResponse>> => {
    const params = workflowId ? `?workflow_id=${workflowId}` : "";
    const response = await apiClient.get<ApiResponse<CanMergeResponse>>(
      `/incidents/merge/can-merge${params}`,
    );
    return response.data;
  },
  ...
  validateMerge: async (
    incidentIds: string[],
  ): Promise<ApiResponse<IncidentMergeValidationResponse>> => {
    const response = await apiClient.post<
      ApiResponse<IncidentMergeValidationResponse>
    >("/incidents/merge/validate", {
  ...
  mergeIncidents: async (
    data: IncidentMergeRequestType,
  ): Promise<ApiResponse<IncidentMergeResponse>> => {
    const response = await apiClient.post<ApiResponse<IncidentMergeResponse>>(
      "/incidents/merge",
      data,
    );
    return response.data;
  ...
  unmergeIncident: async (
    data: IncidentUnmergeRequest,
  ): Promise<ApiResponse<IncidentUnmergeResponse>> => {
    const response = await apiClient.post<ApiResponse<IncidentUnmergeResponse>>(
      "/incidents/merge/unmerge",
      data,
    );
    return response.data;
  },

  bulkUnmergeIncidents: async (
    data: IncidentBulkUnmergeRequest,
  ): Promise<ApiResponse<IncidentBulkUnmergeResponse>> => {
    const response = await apiClient.post<
      ApiResponse<IncidentBulkUnmergeResponse>
    >("/incidents/merge/bulk-unmerge", data);
    return response.data;
  },

  getMergedIncidents: async (
