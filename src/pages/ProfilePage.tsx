    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-lg shadow-blue-500/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <Card className="overflow-hidden shadow-lg border-border">
            {/* Gradient Header */}
            <div className="h-28 bg-gradient-to-br from-primary to-accent relative overflow-hidden">
            ...
            <div className="px-6 pb-6">
              <div className="relative -mt-14 mb-5">
                <div className="relative inline-block">
                  {user?.avatar ? (
                    ...
                    <div className="w-28 h-28 rounded-2xl bg-gradient-to-br from-primary  to-accent flex items-center justify-center border-4 border-white shadow-xl ring-4 ring-slate-100">
              ...
              <div className="flex justify-center gap-2 flex-wrap mb-6">
                ...
                {user?.roles?.slice(0, 3).map((role) => (
                  <span
                    key={role.id}
                    className="px-3 py-1.5 bg-primary/10 text-primary border border-border text-xs font-semibold rounded-lg"
                  >
                    {role.name}
                  </span>
                ))}
              ...
              <div className="mt-6 pt-6 border-t border-border space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm pt-3 border-t border-border">
              ...
              {/* Upload Hint */}
              <p className="text-xs text-slate-400 text-center bg-slate-50  dark:bg-muted py-2 rounded-lg mt-4">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="shadow-lg border-border p-4">
